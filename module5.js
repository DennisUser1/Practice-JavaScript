// У якому форматі записується властивість об'єкта? Ключ: значення
// Який ключ записано з помилкую? 2catch
// const user = {
//    email: "mango@mail.com"
// }
// Синтаксично правильне значення до властивості email об'єкта user - user['user'] 
// Метод об'єкту це - властивість, значення якого є функція
...
// const userB = userA;
// userB.age = 30;
// console.log(userA.age, userB.age); // Буде виведено 30 та 30

// Для перевобу властивостей (ключів чи значень) об'єкта використовується цикл for...in

// Як отримати список всіх ключів об'єктів? Object.keys(user)
// const user = {
//     username: "Mango",
//     age: 20,
//     status: "online"
