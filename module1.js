...
// console.log(a == b) // нестроге порівняння, порівняння з приведенням типів
...
// "mango".indexOf("nam") не знайшов підстроку, тому повертає -1.
...
// console.log(Math.round(value)) // < .5 floor | >= .5 ceil
...
// console.log("2" > "12"); // true - Unicode table, порівняння символів, дивитися через charCodeAt
