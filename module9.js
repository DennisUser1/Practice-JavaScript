// Ключове слово this містить посилання на об'єкт, у контексті якого функція викликається
// Чи є у стрілочних функцій власне this? False
// Яка різниця між методами call()/apply() та методом bind()? call()/apply() викликають функцію на місці, bind() повертає її копію
// Оберіть коректний виклик методу call() для функції foo() із двома параметрами? foo.call({}, 5, 10)
// function foo(a, b) {
//     console.log(this, a, b);
// }
// Оберіть коректний виклик методу apply() для функції foo() із двома параметрами? foo.apply({}, [5, 10])
// function foo(a, b) {
//     console.log(this, a, b);
// }
