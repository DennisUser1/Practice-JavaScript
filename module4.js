...
// Test 2
// greet() // Помилка доступу до змінної greet

// const greet = function () {
//     console.log("Welcome")
// }

// Приклад вірної функції
foo ();
function foo() {
...
// Test 3. Що містить локальна змінна arguments у тілі функції? Псевдомасив аргументів

// function foo () {
//     console.log(arguments);
// }

// Test 4. Що буде виведено у консоль?
function bar () {
    console.log(arguments);
}
...
// Що доступне в області видимості функції? Набір локальних та глобальних змінних 
...
// Функція повинна робити одну дію, а не три, як в прикладі
